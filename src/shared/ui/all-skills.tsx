...
export const ALL_SKILLS: SkillData[] = [
  ...
  {
    name: "RESTful APIs",
    icon: <TbApi title="RESTful APIs" />,
    category: "Backend & APIs",
  },
  {
    name: "JWT & OAuth",
    icon: <SiJsonwebtokens title="JWT & OAuth" />,
    category: "Backend & APIs",
  },
  {
    name: "API Security & Validation",
    icon: <FaShieldAlt title="API Security" />,
    category: "Backend & APIs",
  },
  ...
  },
  {
    ...
    icon: <SiGooglecloud title="Google Cloud Platform" />,
    category: "DevOps & Cloud",
  },
  {
    name: "Firebase",
  ...
  },
  {
    ...
    icon: <FaBrain title="Prompt Engineering" />,
    category: "AI Integration",
  },
  {
    name: "AI Streaming Responses",
    icon: <FaStream title="AI Streaming" />,
    category: "AI Integration",
  },
  {
    name: "Token & Cost Optimization",
    icon: <FaChartLine title="Cost Optimization" />,
    category: "AI Integration",
  },
  {
    name: "AI Workflows & Automation",
    icon: <FaTasks title="AI Automation" />,
    category: "AI Integration",
  },
