...
import { ExperienceItemType as BaseExperienceItemType, WorkExperience } from "@/shared/ui/work-experience";
    ...
    positions: [
      {
        ...
        skills: ["React", "TypeScript", "Tailwind CSS", "Express.js", "MongoDB", "Node.js", "Systems Design"],
    ...
    positions: [
      {
        ...
        skills: ["React.js", "JavaScript ES6+", "CSS3", "TypeScript", "Tailwind CSS", "Redux Toolkit", "REST APIs", "Webpack", "Git", "Axios"],
    ...
    positions: [
      {
        ...
        skills: ["React", "JavaScript", "HTML5", "CSS3", "Legacy Code Optimization", "Package Management"],
        location: "Riyadh, Saudi Arabia",
      },
    ],
  },
    ...
    positions: [
      {
        ...
        skills: ["SQL Server Administration", "MySQL", "Database Security", "Network Security Monitoring"],
    ...
    positions: [
      {
        ...
        skills: ["React", "Node.js", "Express.js", "MongoDB", "TypeScript", "REST APIs", "Tailwind CSS"],
        location: "Remote",
      },
    ],
  },
    ...
    positions: [
      {
        ...
        skills: ["Software Engineering", "Database Systems", "Secure Applications", "System Architecture", "Programming Practices", "Problem Solving"],
        location: "Gaza, Palestine",
      },
    ],
  },
